...
},{"./util":3,"underscore":4}],2:[function(require,module,exports){
//require("./compute_a2s");
//require("./compute_deflate");
//require("./compute_fillArray");
//require("./compute_getClass");
//require("./compute_getLargeArray");
require("./compute_percentile");

},{"./compute_percentile":1}],3:[function(require,module,exports){
var _ = require('underscore'),
    timers = {},
    table = function(){
        var width = 800;
